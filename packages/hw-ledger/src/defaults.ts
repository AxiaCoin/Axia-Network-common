...
import type { AxlibApp } from '@zondax/ledger-axlib';

import { newCentrifugeApp, newDockApp, newEdgewareApp, newEquilibriumApp, newAXIALunarApp, newNodleApp, newAXIAApp, newPolymeshApp, newStatemineApp } from '@zondax/ledger-axlib';

// These match up with the keys of the knownLedger object in the @axia-js/networks/defaults.ts
export const ledgerApps: Record<string, (transport: Transport) => AxlibApp> = {
