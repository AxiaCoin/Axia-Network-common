const axiaHwLedger = (function (exports, util) {
  ...
  // ## Main Version
  // Three axc-separated numeric identifiers.
  ...
  // ## Pre-release Version
  // Hyphen, followed by one or more axc-separated pre-release version
  // identifiers.
  ...
  var AxlibApp = /*#__PURE__*/function () {
    function AxlibApp(transport, cla, slip0044) {
      (0, _classCallCheck2.default)(this, AxlibApp);
    ...
    (0, _createClass2.default)(AxlibApp, [{
      key: "getVersion",
      value: function () {
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  bip44Path = AxlibApp.serializePath(this.slip0044, account, change, addressIndex);
                  p1 = 0;
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  chunks = AxlibApp.signGetChunks(this.slip0044, account, change, addressIndex, message);
            ...
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  ...
                  chunks.push.apply(chunks, (0, _toConsumableArray2.default)(AxlibApp.GetChunks(message)));
      ...
      value: function signGetChunks(slip0044, account, change, addressIndex, message) {
        var chunks = [];
        var bip44Path = AxlibApp.serializePath(slip0044, account, change, addressIndex);
  ...
  function newAxiaTestApp(transport) {
    return new AxlibApp(transport, _config.CLA.AXIATEST, _config.SLIP0044.AXIATEST);
  }

  function newAXIAApp(transport) {
    return new AxlibApp(transport, _config.CLA.AXIA, _config.SLIP0044.AXIA);
  }

  function newPolymeshApp(transport) {
    return new AxlibApp(transport, _config.CLA.POLYMESH, _config.SLIP0044.POLYMESH);
  }

  function newDockApp(transport) {
    return new AxlibApp(transport, _config.CLA.DOCK, _config.SLIP0044.DOCK);
  }

  function newCentrifugeApp(transport) {
    return new AxlibApp(transport, _config.CLA.CENTRIFUGE, _config.SLIP0044.CENTRIFUGE);
  }

  function newEdgewareApp(transport) {
    return new AxlibApp(transport, _config.CLA.EDGEWARE, _config.SLIP0044.EDGEWARE);
  }

  function newEquilibriumApp(transport) {
    return new AxlibApp(transport, _config.CLA.EQUILIBRIUM, _config.SLIP0044.EQUILIBRIUM);
  }

  function newGenshiroApp(transport) {
    return new AxlibApp(transport, _config.CLA.GENSHIRO, _config.SLIP0044.GENSHIRO);
  }

  function newStatemintApp(transport) {
    return new AxlibApp(transport, _config.CLA.STATEMINT, _config.SLIP0044.STATEMINT);
  }

  function newStatemineApp(transport) {
    return new AxlibApp(transport, _config.CLA.STATEMINE, _config.SLIP0044.STATEMINE);
  }

  function newNodleApp(transport) {
    return new AxlibApp(transport, _config.CLA.NODLE, _config.SLIP0044.NODLE);
  }

  function newSoraApp(transport) {
    return new AxlibApp(transport, _config.CLA.SORA, _config.SLIP0044.SORA);
  }
