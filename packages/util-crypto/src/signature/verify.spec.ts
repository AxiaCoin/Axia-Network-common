...
import { hexToU8a, stringToU8a, u8aConcat, u8aToHex, u8aWrapBytes } from '@axia-js/util';
...
describe('signatureVerify', (): void => {
  ...
  describe('verifyDetect', (): void => {
    ...
    it('verifies an ethereum signature (known)', (): void => {
      const message = 'Pay AXCTs to the AXIALunar account:88dc3417d5058ec4b4503e0c12ea1a0a89be200fe98922423d4334014fa6b0ee';
