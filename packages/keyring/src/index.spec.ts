...
import { hexToU8a, stringToU8a } from '@axia-js/util';
import { base64Decode, cryptoWaitReady, encodeAddress, randomAsU8a, setSS58Format } from '@axia-js/util-crypto';
...
describe('keypair', (): void => {
  ...
  describe('util', (): void => {
    ...
    it('can re-encode an address to AXIA live', (): void => {
      expect(
